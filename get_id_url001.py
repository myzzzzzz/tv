...
# 将时间戳作为变量传入URL
url = f"https://portal.gcable.cn:8084/PortalServer-App/new/ptl_ipvp_live_live005?categoryID=0&channelName=&countyName=&end=1000&locationName=&pappName=GoodTV&pkv=1&plocation=001&programName=&pserialNumber=c4e9ad95722e8fc64271c36c8e0ea687&pserverAddress=portal.gcable.cn&ptoken=dzsUJ2K3evgfZHJ6Ub6W2w%253D%253D&ptype=3&puser=18925918576&pversion=030107&sortType=2&sscert=true&start=0&timestamp={current_timestamp}&version=v3.5.0%283431%29"
...
if response.status_code == 200:
    ...
    if "channelInfos" in data["data"]:
        ...
        # 创建或打开文件 gudou_channel_id.txt 以便写入数据
        with open("gudou_channel_id.txt", "w", encoding="utf-8") as file:
...
print("结果已保存到 gudou_channel_id.txt 文件.")

# 读取TXT文件内容
with open("gudou_channel_id.txt", "r", encoding="utf-8") as txt_file:
    lines = txt_file.readlines()

# 创建M3U文件并写入内容
with open("gudou_channels.m3u", "w", encoding="utf-8") as m3u_file:
...
print("M3U文件 gudou_channels.m3u 已生成并替换播放链接。")